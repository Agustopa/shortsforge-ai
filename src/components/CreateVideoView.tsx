...
export const CreateVideoView: React.FC<CreateVideoViewProps> = ({
  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 max-w-4xl mx-auto space-y-6 sm:space-y-8">
      {/* Header */}
      ...
      {/* Main Creation Card */}
      <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-slate-900/90 border border-slate-800 shadow-2xl space-y-5 sm:space-y-6">
        {/* Large Topic Input */}
        <div className="space-y-2">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-slate-950 border border-slate-700/80 text-white placeholder-slate-500 text-sm sm:text-base md:text-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all resize-none shadow-inner"
            />
          </div>
          {/* Quick Idea Starters */}
          <div className="flex flex-wrap items-center gap-1.5 pt-1">
            ...
            {sampleIdeas.map((s, idx) => (
              <button
                ...
                type="button"
                onClick={() => setTopic(s)}
                className="px-2.5 py-1 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-300 text-[11px] border border-slate-700/60 transition-colors cursor-pointer"
              >
                {s}
              </button>
            ))}
        ...
        {/* Auto Mode Switch */}
        <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-r from-amber-950/30 to-orange-950/20 border border-amber-800/40 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors relative cursor-pointer shrink-0 min-h-[44px] flex items-center p-0.5 ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4 pt-1">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full min-h-[44px] h-11 px-3.5 rounded-xl bg-slate-950 border border-slate-700 text-slate-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50 cursor-pointer"
            >
              {languages.map(l => (
            ...
            <div className="grid grid-cols-5 gap-1">
              {durations.map(d => (
                <button
                  ...
                  className={`min-h-[44px] h-11 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center ${
                    duration === d.value
        ...
        <div className="pt-2">
          <button
            ...
            className="flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-amber-400 transition-colors cursor-pointer min-h-[44px]"
          >
          ...
          {showAdvanced && (
            <div className="mt-3 p-4 sm:p-5 rounded-2xl bg-slate-950/60 border border-slate-800/80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 sm:gap-4 text-xs">
              {/* Platform */}
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full min-h-[44px] h-10 px-3 rounded-xl bg-slate-900 border border-slate-700 text-slate-200 text-xs"
                >
        ...
        <button
          ...
          className="w-full min-h-[52px] h-14 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r from-amber-500 via-orange-500 to-rose-600 hover:from-amber-400 hover:to-rose-500 disabled:opacity-50 disabled:cursor-not-allowed text-slate-950 font-black text-base sm:text-lg md:text-xl shadow-xl shadow-orange-950/50 hover:shadow-orange-900/70 transition-all flex items-center justify-center gap-3 cursor-pointer group active:scale-[0.99]"
        >
          <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-slate-950 group-hover:rotate-12 transition-transform" />
